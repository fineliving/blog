---
title: 第3章 CSS3的颜色，透明属性，颜色模式，渐变
date: 2020-11-20 16:44:46
permalink: /pages/213c60/
categories:
  - 《CCS3-技术胖》
tags:
  -
...
<style>
  #background {
    background: url(https://cdn.jsdelivr.net/gh/coalyer/image-store@master/blog/css3-jspang/rectangle.jpg) center;
    width: 1300px;
    height: 500px;
    margin: 80px auto;
    position: relative;
  ...
  <body>
    <div class="main">
      <ul>
        <li>
          <div class="img">
            <img src="https://cdn.jsdelivr.net/gh/coalyer/image-store@master/blog/css3-jspang/goods.jpg" alt="新品九阳不用手洗破壁机静音料理全自动" />
          </div>
...
<template>
  <body>
    <div class="ceng rotate_left">
      <img src="https://cdn.jsdelivr.net/gh/coalyer/image-store@master/blog/css3-jspang/ballade_dream.jpg" alt="" />
      <p>世界上最好的风景就是在你的身旁，现在我告诉你了</p>
    </div>
    <div class="ceng rotate_right">
      <img src="https://cdn.jsdelivr.net/gh/coalyer/image-store@master/blog/css3-jspang/china_pavilion.jpg" alt="" />
