...
例如，这张 JPG 图片（最初为 1280 x 720，已调整大小以在此处显示）是 2015 年在澳大利亚用手机相机拍摄的。
...
![TinyPng](https://developers.google.cn/web/fundamentals/performance/get-started/images/image_411.png) _TinyPng_
