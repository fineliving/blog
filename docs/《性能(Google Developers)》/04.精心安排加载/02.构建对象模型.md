---
title: 构建对象模型
date: 2020-11-21 16:44:16
permalink: /pages/f31118/
categories:
...
以上面的 CSSOM 树为例进行更具体的阐述。_span_ 标记内包含的任何置于 body 元素内的文本都将具有 16 像素字号，并且颜色为红色 — font-size 指令从 body 向下级联至 span。不过，如果某个 span 标记是某个段落 (p) 标记的子项，则其内容将不会显示。
