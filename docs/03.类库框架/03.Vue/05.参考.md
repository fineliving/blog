...
![props-sync](/Users/liyang/项目/011-我的博文/image-store/blog/library/vue/props-sync.png)
...
子组件用emit+update方式改变父组件

![emit-update](/Users/liyang/项目/011-我的博文/image-store/blog/library/vue/emit-update.png)
...
v-else 用于（比如：表单中带展开时，先造个空白块用于loading展示）

![v-else](/Users/liyang/项目/011-我的博文/image-store/blog/library/vue/v-else.png)
...
1、一定要着重训练自己的vue数据驱动逻辑，如对map layer与vue.data的联动（详见：retina-mnibss中的图层管理写法）
...
![window](/Users/liyang/项目/011-我的博文/image-store/blog/library/vue/window.png)
...
![v-slot](/Users/liyang/项目/011-我的博文/image-store/blog/library/vue/v-slot.png)
...
![attribute-object](/Users/liyang/项目/011-我的博文/image-store/blog/library/vue/attribute-object.png)



 [适合 Vue 初学者或 Vue2 迁移者的一些 Vue3 知识点](https://mp.weixin.qq.com/s/nrrDNIuazfOUYLCOldMDpw) 
...
物联网5G专网项目-前端开发规约_V1.0.docx
 ...
 [（微信开发）概述 | 微信开放文档](https://developers.weixin.qq.com/doc/offiaccount/OA_Web_Apps/JS-SDK.html) 

 [（模仿的项目，学里面的主题设置）vivue](https://qfstudy.github.io/vivue-build-vuepress/) 

 [（process.env.NODE_ENV）生产环境部署 — Vue.js](https://cn.vuejs.org/v2/guide/deployment.html) 

 [（vue使用第三方包用到的两种不同方式）API — Vue.js](https://cn.vuejs.org/v2/api/#Vue-component) 

 [前端如何引用自己发布的库 - 国内版 Bing](https://cn.bing.com/search?q=%E5%89%8D%E7%AB%AF%E5%A6%82%E4%BD%95%E5%BC%95%E7%94%A8%E8%87%AA%E5%B7%B1%E5%8F%91%E5%B8%83%E7%9A%84%E5%BA%93&qs=n&form=QBRE&sp=-1&pq=%E5%89%8D%E7%AB%AF%E5%A6%82%E4%BD%95%E5%BC%95%E7%94%A8%E8%87%AA%E5%B7%B1%E5%8F%91%E5%B8%83%E7%9A%84%E5%BA%93&sc=0-12&sk=&cvid=5C23B356DB894550A98DDCE13D2A3B97)  

[（从0封装插件/组件库，注意如何发npm）前端如何搭建vue UI组件库/封装插件(从零到有) - 小短腿奔跑吧 - 博客园](https://www.cnblogs.com/gqx-html/p/10821224.html)  

[（我的npm包）retina-gis - npm](https://www.npmjs.com/package/retina-gis) 

 [npm publish发布包时出现403错误no_perms Private mode enable, only admin can publish this module: - 黑熊君 - 博客园](https://www.cnblogs.com/luowenshuai/p/9286297.html)  

[(2条消息)npmpublish发布时的踩坑记录_zem-CSDN博客](https://blog.csdn.net/zemprogram/article/details/104135553) 
...
2、由于div是嵌套的，注意el-dialog应该在的位置（影视全屏的，如下图），不应该存在与如 fe-gis-tool中，会造成下图的结果。

3、通过上边的2：1、学会了vue如何模块化。2、如何css布局

![image-20210827153813310](/Users/liyang/Library/Application Support/typora-user-images/image-20210827153813310.png)

![image-20210827154107382](/Users/liyang/Library/Application Support/typora-user-images/image-20210827154107382.png)

![image-20210827154145212](/Users/liyang/Library/Application Support/typora-user-images/image-20210827154145212.png)

改成了flex布局，区别于原el-dialog

![image-20210827155612651](/Users/liyang/Library/Application Support/typora-user-images/image-20210827155612651.png)
...
![image-20210830143052344](/Users/liyang/Library/Application Support/typora-user-images/image-20210830143052344.png)
...
![image-20210830163613586](/Users/liyang/Library/Application Support/typora-user-images/image-20210830163613586.png)
